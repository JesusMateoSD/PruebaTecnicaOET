<?php
  if(isset($_POST['reg_pro'])){
    ...
    $vehiculo = new PropietarioControlador();
    $vehiculo->registrarPropietarioControlador();
  }

  if($_GET['action'] == 'propok'){
    ?>
    <script LANGUAGE="javascript">
       $(document).ready(function() {
         swal({
           title: 'ACME S.A.',
           text: "El Propietario fue grabado correctamente!",
           type: 'success',
...
<main class="container ">  
  <div class="p-2 mt-5 bg-primary text-white">Registrar propietarios</div>
  <hr>  
  <body>
    <div class="container">
      <div class="row">
        <form id="myForm" name="f" method="POST" >
          ...
          <input type="submit" name="reg_pro" id="reg_pro" class="btn btn-success mx-2" value="Registrar propietario">
          </form>
        </div>
      </div>
      <br>
